Feature: Verify register Feature
  ...
  Scenario: User should create account successfully
    ...
    And I select day for DOB "21"
    And I select month for DOB "March"
    And I select year for DOB "1995"
    And I enter email for registration
    And I enter password for registration "ravina@10"
    And I enter confirm password for registration "ravina@10"
